 ...
 *
 * <p><strong>The heuristic is <a href="http://en.wikipedia.org/wiki/Admissible_heuristic">admissible</a>
 * (or optimistic)</strong>: it will never overestimate the remaining cost. A {@link Solver} will still function
 * with non-admissible heuristics, but may fail to find the optimal solution (depending on the implementation).</p>
 *
