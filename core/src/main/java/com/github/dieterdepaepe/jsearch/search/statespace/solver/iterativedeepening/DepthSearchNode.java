 ...
 * <p/>
 * Despite its name, the depth does not need to be equal to the depth of the search node in the search tree. It can be
 * used as any general limitation for the search space.
