...
/**
 * Testing class for {@link com.github.dieterdepaepe.jsearch.search.statespace.solver.AStarStateSolver}.
 */
public class AStarStateSolverTest extends BasicSolverTest {
    ...
    public void testNodeExpansionOrder() {
        ...
        assertEquals(generator.getExpandedNodes(), Arrays.asList(a1, b1, c1, e, b2, c2));
