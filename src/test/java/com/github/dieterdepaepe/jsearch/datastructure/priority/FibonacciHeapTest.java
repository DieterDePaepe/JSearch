...
public class FibonacciHeapTest {
    ...
    public void testPriorityOrderWithoutDuplicates() {
        ...
        for (int expectedValue = 0; expectedValue < numberOfEntries; expectedValue++) {
            assertEquals((Integer) heap.findMinimum().getValue(), Integer.valueOf(expectedValue), "Heap returned incorrect element");
            assertEquals((Integer) heap.deleteMinimum().getValue(), Integer.valueOf(expectedValue), "Heap returned incorrect element");
        }
    ...
    public void testPriorityOrderWithDuplicates() {
        ...
        for (Integer value : values) {
            assertEquals((Integer) heap.findMinimum().getValue(), value, "Heap returned incorrect element");
            assertEquals((Integer) heap.deleteMinimum().getValue(), value, "Heap returned incorrect element");
        }
    ...
    public void testDecreaseKey() {
        ...
        List<Integer> originalValues = new ArrayList<Integer>(values);
        Collections.shuffle(values, random);
        ...
        for (int i = 0; i < 999; i++) {
            assertEquals((Double) heap.findMinimum().getKey(), (double) i, "Heap entry contains incorrect key");
            assertEquals((Integer) heap.deleteMinimum().getValue(), Integer.valueOf(i), "Heap returned incorrect element");
        }
        ...
        assertEquals((Integer) heap.deleteMinimum().getValue(), Integer.valueOf(999));
    ...
    public void testMerge() {
        ...
        FibonacciHeap<Object> heap2 = new FibonacciHeap<Object>();
        for (Integer value : values2)
            heap2.insert(null, value);

        FibonacciHeap<Object> heap3 = new FibonacciHeap<Object>();
        ...
        List<Integer> expectedValues = new ArrayList<Integer>(10000);
    ...
    public void testDelete() {
        List<FibonacciHeapEntry<Object>> entries = new ArrayList<FibonacciHeapEntry<Object>>();
    ...
    private List<Integer> generateNumbers(int amount, int start, int step) {
        List<Integer> values = new ArrayList<Integer>(amount);
